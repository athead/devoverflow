            ...
            <div className="flex-1">
              ...
              <div className="flex flex-col">
                ...
                <p className="body-regular mt-0.5 text-light-500">
                  {timeDifferenceStringFromNow(new Date(postedAt))}
                </p>
              </div>
            </div>
            <JobBadge
          ...
          <div className="flex-between mt-6 w-full flex-wrap gap-3">
            <div className="flex items-center gap-3 max-sm:flex-wrap max-sm:justify-start">
              ...
              <Metric
                ...
                alt="people"
                value={isRemote ? "Удаленно" : "Офис"}
                textStyles="small-medium text-light-500"
              />
              <Metric
                imgSrc="/assets/icons/currency-dollar-circle.svg"
                alt="dollar circle"
                value={getFormattedSalary(salary) || "Не указано"}
                textStyles="small-medium text-light-500"
              />
            </div>
            <Link
